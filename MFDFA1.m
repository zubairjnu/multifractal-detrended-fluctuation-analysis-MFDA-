...
FFq=Fq';
HHq=Hq';
%save hhq_notch_k22_4.txt hhq -ascii
save Dq_mi_p53_0_005.txt DDq -ascii
%save tq_notch_k22_4.txt ttq -ascii
save Fq_mi_p53_0_005.txt FFq -ascii
save Hq_mi_p53_0_005.txt HHq -ascii
...
% 
%     % Create title
%     title('q-order Hurst exponent of H37Rv_rpoB gene','FontSize',14);
% 
%     % Create plot
